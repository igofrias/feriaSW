...
class EasyContactFormsCustomForms extends EasyContactFormsBase {
	...
	function getAvaliableStyles() {
		...
		$dir->close();
		$styleroot = ABSPATH . 'wp-content/plugins/easycontact_templates/easycontact_templates.php';
	...
	function getManageMainView($viewmap) {
		...
		require_once 'views/easy-contact-forms-customformsmanagemainview.php';
