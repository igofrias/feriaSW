          ...
          <fieldset>
            ...
            <div class='ufo-float-left ufo-width50'>
              ...
              <div>
                 ...
                 <textarea id='SubmissionSuccessText' class='textinput ufo-textarea ufo-formvalue' style='width:100%;height:250px'><?php echo $obj->get('SubmissionSuccessText');?></textarea>
              </div>
            </div>
            <div class='ufo-float-right ufo-width50'>
              <div>
              ...
              <div>
                 <fieldset>
                   ...
                   <label for='IncludeIntoReporting'><?php echo EasyContactFormsT::get('ShowOnDashboard');?></label>
                   <input type='checkbox' id='IncludeIntoReporting' value='<?php echo $obj->IncludeIntoReporting;?>' <?php echo $obj->IncludeIntoReportingChecked;?> class='ufo-cb checkbox ufo-formvalue' onchange='this.value=(this.checked)?"on":"off"'>
                   <div>
      ...
      <div id='Confirmation1' class='ufo-tabs ufo-tab1'>
        ...
        <div class='ufo-float-left'>
          <div style='padding:0 5px'>
            ...
            <div>
              ...
              <input type='hidden' value='var c = {};c.id = "ConfirmationReplyToAddress";c.events = {};c.events.blur = [];c.minmax={};c.minmax.msg=AppMan.resources.ValueLengthShouldBeLessThan;c.minmax.args=[];c.minmax.args.push("200");c.max="200";c.events.blur.push("minmax");c.invClass = "ufo-fields-invalid-field";AppMan.addValidation(c);' class='ufo-eval'>
            ...
            <div>
              <div id='EmailAdvanced' class='ufo-id-link' style='display:none;padding:0 5px'>
                 ...
                 <div>
                   ...
                   <input type='hidden' value='var c = {};c.id = "ConfirmationReplyToName";c.events = {};c.events.blur = [];c.minmax={};c.minmax.msg=AppMan.resources.ValueLengthShouldBeLessThan;c.minmax.args=[];c.minmax.args.push("200");c.max="200";c.events.blur.push("minmax");c.invClass = "ufo-fields-invalid-field";AppMan.addValidation(c);' class='ufo-eval'>
        ...
        <div style='margin-top:10px'>
          ...
          <div style='margin-right:130px;overflow:auto;padding-right:15px'>
            ...
            <textarea id='ConfirmationText' class='textinput ufo-formvalue' style='width:100%;height:290px'><?php echo $obj->get('ConfirmationText');?></textarea>
          </div>
        </div>
      </div>
            ...
            <div style='padding:5px 15px'>
              ...
              <div class='ufo-float-right ufo-width50'>
                 ...
                 <div>
                   ...
                   <input type='hidden' value='var c = {};c.id = "ReplyToNameTemplate";c.events = {};c.events.blur = [];c.minmax={};c.minmax.msg=AppMan.resources.ValueLengthShouldBeLessThan;c.minmax.args=[];c.minmax.args.push("200");c.max="200";c.events.blur.push("minmax");c.invClass = "ufo-fields-invalid-field";AppMan.addValidation(c);' class='ufo-eval'>
              ...
              <div style='margin-right:130px;overflow:auto;padding-right:15px'>
                 ...
                 <textarea id='NotificationText' class='ufo-formvalue' style='width:100%;height:220px'><?php echo $obj->get('NotificationText');?></textarea>
              </div>
            </div>
          </div>
            ...
            <div class='ufo-float-right ufo-width50'>
              <div>
                 <fieldset>
                   ...
                   <label for='SendConfirmationAsText'><?php echo EasyContactFormsT::get('SendConfirmationAsText');?></label>
                   <input type='checkbox' id='SendConfirmationAsText' value='<?php echo $obj->SendConfirmationAsText;?>' <?php echo $obj->SendConfirmationAsTextChecked;?> class='ufo-cb checkbox ufo-formvalue' onchange='this.value=(this.checked)?"on":"off"'>
                   <label for='SendNotificationAsText'><?php echo EasyContactFormsT::get('SendNotificationAsText');?></label>
                   <input type='checkbox' id='SendNotificationAsText' value='<?php echo $obj->SendNotificationAsText;?>' <?php echo $obj->SendNotificationAsTextChecked;?> class='ufo-cb checkbox ufo-formvalue' onchange='this.value=(this.checked)?"on":"off"'>
                 </fieldset>
              </div>
              <div>
                 ...
                 <input type='hidden' value='var c = {};c.id = "FadingDelay";c.events = {};c.events.blur = [];c.integer={};c.integer.msg=AppMan.resources.ThisIsAnIntegerField;c.events.blur.push("integer");c.invClass = "ufo-fields-invalid-field";AppMan.addValidation(c);' class='ufo-eval'>
              ...
              <div>
                 ...
                 <input type='hidden' value='var c = {};c.id = "MessageDelay";c.events = {};c.events.blur = [];c.integer={};c.integer.msg=AppMan.resources.ThisIsAnIntegerField;c.events.blur.push("integer");c.invClass = "ufo-fields-invalid-field";AppMan.addValidation(c);' class='ufo-eval'>
