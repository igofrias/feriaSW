...
?>
  <div>
    <?php EasyContactFormsLayout::getTabHeader(array('GeneralInfo', 'ContactInfo', 'More', 'History', 'CustomFormMailingLists'), 'top');?>
      ...
      <div id='GeneralInfo' class='ufo-tabs ufo-tab ufo-active'>
        ...
        <div>
          <div>
            ...
            <textarea id='Notes' class='ufo-formvalue' style='width:100%;height:240px'><?php echo $obj->get('Notes');?></textarea>
          </div>
        </div>
      </div>
      <div id='ContactInfo' class='ufo-tabs ufo-tab'>
        <div class='ufo-float-left ufo-width50'>
          ...
          <div>
            ...
            <textarea id='Address' class='textinput ufo-textarea ufo-formvalue' style='width:100%;height:100px'><?php echo $obj->get('Address');?></textarea>
          </div>
        </div>
        <div class='ufo-float-right ufo-width50'>
          <div>
      ...
      <div id='More' class='ufo-tabs ufo-tab'>
        <div>
          <div>
            ...
            <textarea id='ContactField3' class='ufo-formvalue' style='width:100%;height:150px'><?php echo $obj->get('ContactField3');?></textarea>
          </div>
          <div>
            <label for='ContactField4' class='ufo-label-top'><?php echo EasyContactFormsT::get('ContactField4');?></label>
            <?php if (EasyContactFormsApplicationSettings::getInstance()->get('UseTinyMCE')) : 
              EasyContactFormsIHTML::getTinyMCE('ContactField4');
            endif; ?>
            <textarea id='ContactField4' class='ufo-formvalue' style='width:100%;height:190px'><?php echo $obj->get('ContactField4');?></textarea>
          </div>
        </div>
      </div>
      <div id='History' class='ufo-tabs ufo-tab'>
        ...
        <div>
          ...
          <div class='ufo-y-overflow'>
            <div style='width:100%;height:180px'><?php echo $obj->get('History');?></div>
          </div>
        </div>
      </div>
