 ...
 * @file
 *
 * 	EasyContactFormsCustomFormsEntries detailedMain view row html
 * 	function
 *
...
/**
 * 	Displays a EasyContactFormsCustomFormsEntries detailedMain view
 * 	record
 *
 * @param object $view
 * 	the EasyContactFormsCustomFormsEntries detailedMain view object
 * @param object $obj
 * 	a db object
 * @param int $i
 * 	record index
 ...
 * 	request data
 */
function getCustomFormsEntriesDetailedMainViewRow($view, $obj, $i, $map) {
  ...
  <tr class='ufohighlight <?php EasyContactFormsIHTML::getTrSwapClassName($i);?>'>
    ...
    <td>
      <a id='<?php echo $obj->elId('id', $obj->getId());?>' class='ufo-id-link' onclick='ufo.redirect({m:"show", oid:"<?php echo $obj->get('id');?>", t:"CustomFormsEntries"})' onmouseover='ufo.showInfo({t:"CustomFormsEntries", m2:"getASList", oid:<?php echo $obj->get('id');?>, m:"ajaxsuggest"}, this)'>
