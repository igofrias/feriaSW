    ...
    <div class='ufo-tab-wrapper ufo-tab-top'>
      <div id='GeneralSettings' class='ufo-tabs ufo-tab ufo-active'>
        <div class='ufo-float-left ufo-width50'>
          <label for='ShowPoweredBy'><?php echo EasyContactFormsT::get('ShowPoweredBy');?></label>
          <input type='checkbox' id='ShowPoweredBy' value='<?php echo $obj->ShowPoweredBy;?>' <?php echo $obj->ShowPoweredByChecked;?> class='ufo-cb checkbox ufo-formvalue' onchange='this.value=(this.checked)?"on":"off"'>
          ...
          <input type='hidden' value='var c = {};c.id = "PhoneRegEx";c.events = {};c.events.blur = [];c.minmax={};c.minmax.msg=AppMan.resources.ValueLengthShouldBeLessThan;c.minmax.args=[];c.minmax.args.push("100");c.max="100";c.events.blur.push("minmax");c.invClass = "ufo-fields-invalid-field";AppMan.addValidation(c);' class='ufo-eval'>
          ...
          <input type='hidden' value='var c = {};c.id = "FileFolder";c.events = {};c.events.blur = [];c.minmax={};c.minmax.msg=AppMan.resources.ValueLengthShouldBeLessThan;c.minmax.args=[];c.minmax.args.push("100");c.max="100";c.events.blur.push("minmax");c.invClass = "ufo-fields-invalid-field";AppMan.addValidation(c);' class='ufo-eval'>
          ...
          <input type='checkbox' id='FixJSLoading' value='<?php echo $obj->FixJSLoading;?>' <?php echo $obj->FixJSLoadingChecked;?> class='ufo-cb checkbox ufo-formvalue' onchange='this.value=(this.checked)?"on":"off"'>
          ...
          <input type='checkbox' id='FixStatus0' value='<?php echo $obj->FixStatus0;?>' <?php echo $obj->FixStatus0Checked;?> class='ufo-cb checkbox ufo-formvalue' onchange='this.value=(this.checked)?"on":"off"'>
        </div>
        <div class='ufo-float-right ufo-width50'>
          ...
          <fieldset>
            <legend>
              <?php echo EasyContactFormsT::get('FormSettings');?>
            </legend>
            ...
            <input type='hidden' value='var c = {};c.id = "FormCompletionMinTime";c.events = {};c.events.blur = [];c.integer={};c.integer.msg=AppMan.resources.ThisIsAnIntegerField;c.events.blur.push("integer");c.invClass = "ufo-fields-invalid-field";AppMan.addValidation(c);' class='ufo-eval'>
            ...
            <input type='hidden' value='var c = {};c.id = "FormCompletionMaxTime";c.events = {};c.events.blur = [];c.integer={};c.integer.msg=AppMan.resources.ThisIsAnIntegerField;c.events.blur.push("integer");c.invClass = "ufo-fields-invalid-field";AppMan.addValidation(c);' class='ufo-eval'>
      ...
      <div id='AdditionalSettings' class='ufo-tabs ufo-tab'>
        <div>
          <label>
            ...
            <span id='Hin' class='ufo-label-hint ufo-id-link'>[<a>?</a>]</span>
          </label>
          <input type='hidden' id='Hint' value='<?php echo EasyContactFormsT::get('Hint_ApplicationSettings_AdminPartApplicationWidth');?>' class='ufo-id-link'>
        ...
        <div>
          ...
          <input type='hidden' id='Hint' value='<?php echo EasyContactFormsT::get('Hint_ApplicationSettings_AdminPartDefaultStyle');?>' class='ufo-id-link'>
