...
$sharelinks.= '<div class=socialicons style="float:left;margin-right: 10px;"><div id="fb-root"></div><script src="//connect.facebook.net/'.$clang.'/all.js#xfbml=1"></script><fb:like href="'.$fblplink.'" send="'.$snd.'"'.$tp.'show_faces="false" font=""></fb:like></div>';
}
...
$sharelinks.= '<div class=socialicons style="position: relative;'.$cs1.'float:left;margin-right: 10px;"><div '.$cs2.'><a name="fb_share" type="'.$tp.'" share_url="'.$eplink.'" href="http://www.facebook.com/sharer.php">Share</a></div></div>';
}*/
...
<p><b>4 </b>Display Facebook Share (Facebook no longer supports FB share) <a href="http://techxt.com/plugin-support-forum/tweet-like-plusone-and-share-plugin/display-facebook-share-button-custom-button/" target="_blank">Check out the alternative method to display FB Share</a></p>
...
$s4link= '<div class="socialicons s4fblike" style="float:left;margin-right: 10px;"><div id="fb-root"></div>'.$flsc.'<div class="fb-like" data-href="'.$plink.'" data-send="'.$snd.'" '.$tp.' data-show-faces="false"></div></div>';
