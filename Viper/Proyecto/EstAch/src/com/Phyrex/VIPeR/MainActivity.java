...
public class MainActivity extends SherlockFragmentActivity implements BTConnectable{
    ...
    //public static final int STATISTICS = com.actionbarsherlock.view.Menu.FIRST + 4;
  ...
  */
    ...
    ///Creacion de la actividad, inicializacion de botones y texto.
  ...
  //llama al supa framento
    ...
    void launch_statisticslist() {//identificamos y cargamos el fragmento menu
		...
		if(fragment==null){
			...
			ft.add(R.id.frame2, fragment,"statisticslist");
		}
		else{
			if(fragment.isDetached()){
				ft.attach(fragment);
  ...
  ///envia al bthandler los mensajes via blublu   (string)  
    ...
    public boolean onCreateOptionsMenu(com.actionbarsherlock.view.Menu menu) {
        ...
        //myMenu.add(0, STATISTICS, 5, "Estadísticas")/*.setIcon(R.drawable.ic_menu_start)*/;
        myMenu.add(0, MENU_QUIT, 5, getResources().getString(R.string.quit))/*.setIcon(R.drawable.ic_menu_exit)*/;
    ...
    public boolean onOptionsItemSelected(com.actionbarsherlock.view.MenuItem item) {
        switch (item.getItemId()) {
            ...
            case MENU_REMOTE_CONTROL:
        		...
        		if(fragment1!=null){//si estoy en el control remoto
        			detach_controlremoto();
    	    		launch_mainpet();
                } else if(fragment2!=null){//si estoy en el main
                	if (isConnected()){
    	        		detach_mainpet();
            ...
            case ACHIEVEMENTS:
            	SherlockFragment fragment3 = ((Achievement_Activity)getSupportFragmentManager().findFragmentByTag("achievementlist"));
        		SherlockFragment fragment4 = ((MainPetActivity)getSupportFragmentManager().findFragmentByTag("mainpet"));
        		if(fragment3!=null){
        			detach_achievementlist();
    	    		launch_mainpet();
                } else if(fragment4!=null){//si estoy en el main
                	if (!isConnected()){
    	        		detach_mainpet();
        	...
        	/*
            case STATISTICS:
            	SherlockFragment fragment5 = ((Statistics_Activity)getSupportFragmentManager().findFragmentByTag("statisticslist"));
        		SherlockFragment fragment6 = ((MainPetActivity)getSupportFragmentManager().findFragmentByTag("mainpet"));
        		if(fragment5!=null){
        			detach_statisticslist();
    	    		launch_mainpet();
                } else if(fragment6!=null){//si estoy en el main
                	if (!isConnected()){
    	        		detach_mainpet();
