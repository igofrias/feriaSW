...
%%% 
 % Identificar y listar en orden de prioridad los 3 riesgos principales asociados al
 % desarrollo del producto (caracter tecnico)
%%%

\newpage
\section{Justificaci\'on de Riesgo Principal.}
%%%
 % seleccionar y justificar el riesgo principal que sera abordado
%%%

\newpage
\section{Identificaci\'on de Medidas de Mitigaci\'on Principales.}
%%%
 % Proponer medidas de mitigacion para el riesgo principal (indicando que artefactos
 % se construiran para afrontar el riesgo)
%%%

\newpage
\section{Justificaci\'on de las Medidas de Mitigaci\'on.}
%%%
 % Explicar/justificar como las medidas mitigaran el riesgo principal identificado
 % 
%%%
